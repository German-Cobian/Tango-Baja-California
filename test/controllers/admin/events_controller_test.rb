...
class Admin::EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_event" do
    assert_difference("Admin::Event.count") do
      post admin_events_url, params: { admin_event: { description: @admin_event.description, end_time: @admin_event.end_time, hosted_by: @admin_event.hosted_by, place: @admin_event.place, start_time: @admin_event.start_time, title: @admin_event.title } }
    end
  ...
  test "should update admin_event" do
    patch admin_event_url(@admin_event), params: { admin_event: { description: @admin_event.description, end_time: @admin_event.end_time, hosted_by: @admin_event.hosted_by, place: @admin_event.place, start_time: @admin_event.start_time, title: @admin_event.title } }
