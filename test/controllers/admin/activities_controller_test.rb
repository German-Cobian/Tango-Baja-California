...
class Admin::ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_activity" do
    assert_difference("Admin::Activity.count") do
      post admin_activities_url, params: { admin_activity: { category: @admin_activity.category, description: @admin_activity.description, place: @admin_activity.place, time: @admin_activity.time, title: @admin_activity.title } }
    end
  ...
  test "should update admin_activity" do
    patch admin_activity_url(@admin_activity), params: { admin_activity: { category: @admin_activity.category, description: @admin_activity.description, place: @admin_activity.place, time: @admin_activity.time, title: @admin_activity.title } }
